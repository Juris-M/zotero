...
describe("PDF Reader", function () {
	...
	describe('Reader', function () {
		it('should create/update annotations', async function () {
			...
			var n = 0;
			while ((!reader._iframeWindow || !reader._iframeWindow.wrappedJSObject.PDFViewerApplication || !reader._iframeWindow.wrappedJSObject.PDFViewerApplication.pdfDocument) && n++ < 150) {
